...
1. **Recibo imprimible (`imprimirRecibo`, #39d):** **✅ Plantilla v2 lista (2026-09-13):** header con RECIBO #ID + estado, tarjetas Cliente/Entrega, tabla Descripción compacta, totales, notas, firmas y footer; botones Imprimir/Cerrar. Samir la probó — queda abierta a ajustes (logo, colores, textos, contacto).
